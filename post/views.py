...
class ArticleDisplay(DataMixin, DetailView):
    ...
    def get_context_data(self, **kwargs):
        ...
        form = AddCommentForm()
        c_def = self.get_data(title = title, comment_list = comment_list, category_list = category_list, form = form)
        return c_def | context
...
class CategoryDetail(DataMixin, DetailView):
    ...
    def get_context_data(self, **kwargs):
        ...
        c_def = self.get_data(title = context['category'].name, article_list = article_list)
        return c_def | context
